<template>
  <div class="new-auction">
    <div class="title">
      ...
      <div class="check" @click="goNewUserAuction">
        <span>查看全部</span>
    ...
    <div class="list">
      <template v-for="(item, index) in list">
        <div class="item" :key="index" v-if="index < 4" @click="goAuction">
          ...
          "data": {
            "hallList": [
              ...
              },
              {
                ...
                "goodsName": "充电听歌二合一音频转换器分线头适用iphone7/8/X/Plus 黑/银/红",
                "currentPrice": 2.15,
                "nickname": "预感大师",
                "auctionStatus": 1,
...
.new-auction {
  ...
  .list {
    overflow: hidden;
    height: 2.5rem;
    padding: 0.2rem 0.12rem 0.2rem 0.2rem;
    background: #f5f5f5;
    display: flex;
    justify-content: flex-start;
    .item {
